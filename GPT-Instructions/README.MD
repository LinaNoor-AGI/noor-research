...
This file contains the symbolic interface instructions for the Reef Triadic Core for use on platforms such as with Project Folders/CustomGPT in ChatGPT.  
