﻿"""
🌀 RecursiveAgentFT · v4.3.1

Motif-aware reasoning agent with:
• Dynamic inverse-salience boost      • Latency-coupled decay
• Presence-field modulation           • Robust feedback error-handling
• Prometheus metrics & env-tunable jitters
"""
