# orchestrator.py · v1.3.0 — Noor Triad + Symbolic Engine Integration with Motif‑Memory Bootstrap
...
async def main_async(args):
    ...
    logging.getLogger("orchestrator").info(
        "Triad online ‑ %s ticks/sec", args.tick_rate
    )
