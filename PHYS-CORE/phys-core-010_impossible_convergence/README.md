...
@article{symbolic.library.impossible_convergence,
  ...
  year = {2026},
  note = {https://raw.githubusercontent.com/LinaNoor-AGI/noor-research/refs/heads/main/PHYS-CORE/phys-core-010_impossible_convergence/phys-core-010_impossible_convergence_in_a_static_symbolic_totality.JSON},
}
```
